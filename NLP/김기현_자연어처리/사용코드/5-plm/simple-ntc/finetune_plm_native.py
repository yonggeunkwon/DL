...
def define_argparser():
    ...
    p.add_argument('--verbose', type=int, default=2)  # 숫자가 높을수록 자세하게 보여줌
...
def get_loaders(fn, tokenizer, valid_ratio=.2):
    ...
    train_loader = DataLoader(
        ...
        shuffle=True,  # training set이기 때문에
...
if __name__ == '__main__':  # 실행허면 여기로
    config = define_argparser()  # 사용자가 필요한 hyperparameter들을 여기서 입력받음
    main(config)
